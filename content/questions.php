<div class="collapsible-body">
    <div class="row">
        <div class="col s12">
            <p style="text-align: center">For the Questions 1 - 4 we are using information about the cinema SP1 (id = 1)</p>
            <ul class="tabs">
        ...
        <div id="q1" class="col s12">
            ...
            <p><i>Product Ticket Family = 1</i></p>
            <?php
...
order by percentage_popcorn_softdrinks desc;
        ...
        <div id="q3" class="col s12">
            <p><b>3. At which session is there the most number of people.</b></p>
            <?php
                $sql3 = "
